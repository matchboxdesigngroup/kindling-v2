...
use Kindling\PostType\Base;

/**
 * You basically need to change [stub/Stub] to be your post type name.
 * Please do take a look at Kindling\PostType\Base to see what parameters
 * and methods are already available to use.
 *
 * The properties of Kindling\PostType\Base that you should/can alter are
...
class Stub extends Base
{
    ...
    {
        // Kindling\PostType\Base Properties.
        $this->setOptions();
    ...
    /**
     * Handles setting of the optional properties of Kindling\PostType\Base
     */
