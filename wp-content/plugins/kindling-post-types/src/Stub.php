 ...
 * Please do take a look at Base to see what parameters
 * and methods are already available to use.
 *
 * The properties of Base that you should/can alter are
...
class Stub extends Base
{
    ...
    public function __construct()
    {
        ...
        $this->addTypeActionsFilters();

        parent::__construct('stub', 'Stubs', 'Stub');
    } // __construct()

    /**
     * Handles setting of the optional properties of Base
     */
     ...
     */
    private function setPostTypeOptions()
    {
        /**
         ...
         * @var array
         */
        $this->custom_post_type_supports = [
            'title',
            'editor',         // (content)
            'author',
        ...
        $this->custom_post_type_args = array(
            ...
            'show_in_menu'       => true,
            'query_var'          => true,
            'rewrite'            => ['slug' => $this->landing_page_slug, 'with_front' => false],
     ...
     */
    private function addTypeActionsFilters()
    {
        // Uncomment to redirect the single page to the landing page.
        // add_action( 'template_redirect', array( &$this, 'singleRedirect' ) );
    } // addTypeActionsFilters()
     ...
     * @return void
     */
    public function singleRedirect()
    {
